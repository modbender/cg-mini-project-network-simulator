...
void move1() //MOVEMENT OF FRAME 0  (in safe sending)
{
	...
	for (j = 0; j < 60; j = j + temp) //to move the  packet from bottom to top
	{
		glColor3f(1, 0, 0);
		glBegin(GL_QUADS);
		glVertex2i(305, 178 + j);
		glVertex2i(305, 193 + j);
		glVertex2i(310, 193 + j);
		glVertex2i(310, 178 + j);
		glEnd();
		glFlush();
...
void move2() // SIMULTANEOUS  MOVEMENT OF ACK 1 AND FRAME 1(in safe sending)
{
	...
	for (j = 0; j < 4; j = j + temp) //movement of data packet within the frame
	{
		glColor3f(0, 1, 1);
		glBegin(GL_QUADS);
		glVertex2i(320, 265 - j);
		glVertex2i(320, 275 - j);
		glVertex2i(325, 275 - j);
		glVertex2i(325, 265 - j);
		glEnd();
		glFlush();
	...
	for (j = 0; j < 60; j = j + temp) //movement of data packet from top to down
	{
		glColor3f(0, 1, 1);
		glBegin(GL_QUADS);
		glVertex2i(320, 228 - j);
		glVertex2i(320, 238 - j);
		glVertex2i(325, 238 - j);
		glVertex2i(325, 228 - j);
		glEnd();
		glFlush();
	...
	for (i = 0; i < 235; i = i + temp) //movement of data packet sidewise
	{
		glColor3f(0, 1, 1);
		glBegin(GL_QUADS);
		glVertex2i(310 - i, 168);
		glVertex2i(310 - i, 173);
		glVertex2i(320 - i, 173);
		glVertex2i(320 - i, 168);
		glEnd();
		glFlush();
	...
	for (j = 0; j < 63; j = j + temp) //to move the  packet from bottom to top
	{
		...
		glColor3f(1, 0, 0);
		glBegin(GL_QUADS);
		glVertex2i(320, 178 + j);
		glVertex2i(320, 193 + j);
		glVertex2i(325, 193 + j);
		glVertex2i(325, 178 + j);
		glEnd();
		glFlush();
...
void move3() // MOVEMENT OF FRAME 2 ( FRAME 2 lost in packet crashing)
{
	...
	for (i = 0; i < 167; i = i + temp) //movement of data packet sidewise
	{
		...
		glVertex2i(85 + i, 178);
		glVertex2i(85 + i, 183);
		glVertex2i(100 + i, 183);
		glVertex2i(100 + i, 178);
		glEnd();
		glFlush();
...
void move4() // RESENDING OF FRAME 2 (in packet crashing)
{
	...
	for (j = 0; j < 60; j = j + temp) //to move the  packet from bottom to top
	{
		glColor3f(1, 0, 0);
		glBegin(GL_QUADS);
		glVertex2i(335, 178 + j);
		glVertex2i(335, 193 + j);
		glVertex2i(340, 193 + j);
		glVertex2i(340, 178 + j);
		glEnd();
		glFlush();
...
void move5() // sending of frame 3
{
	...
	for (j = 0; j < 4; j = j + temp) //movement of data packet within the frame
	{
		glColor3f(1, 0, 0);
		glBegin(GL_QUADS);
		glVertex2i(100, 265 - j);
		glVertex2i(100, 280 - j);
		glVertex2i(105, 280 - j);
		glVertex2i(105, 265 - j);
		glEnd();
		glFlush();
	...
	for (j = 0; j < 50; j = j + temp) //movement of data packet from top to down
	{
		glColor3f(1, 0, 0);
		glBegin(GL_QUADS);
		glVertex2i(100, 238 - j);
		glVertex2i(100, 253 - j);
		glVertex2i(105, 253 - j);
		glVertex2i(105, 238 - j);
		glEnd();
		glFlush();
	...
	for (i = 0; i < 235; i = i + temp) //movement of data packet sidewise
	{
		...
		glBegin(GL_QUADS);
		glVertex2i(100 + i, 183);
		glVertex2i(100 + i, 188);
		glVertex2i(115 + i, 188);
		glVertex2i(115 + i, 183);
		glEnd();
		glFlush();
	...
	for (j = 0; j < 55; j = j + temp) //to move the  packet from bottom to top
	{
		...
		glColor3f(1, 0, 0);
		glBegin(GL_QUADS);
		glVertex2i(350, 183 + j);
		glVertex2i(350, 198 + j);
		glVertex2i(355, 198 + j);
		glVertex2i(355, 183 + j);
		glEnd();
		glFlush();
...
void move7() // MOVEMENT OF ACK 4 (in packet crashing)
{
	...
	for (j = 0; j < 4; j = j + temp) //movement of data packet within the frame
	{
		glColor3f(0, 1, 1);
		glBegin(GL_QUADS);
		glVertex2i(365, 265 - j);
		glVertex2i(365, 275 - j);
		glVertex2i(370, 275 - j);
		glVertex2i(370, 265 - j);
		glEnd();
		glFlush();
	...
	for (j = 0; j < 50; j = j + temp) //movement of data packet from top to down
	{
		glColor3f(0, 1, 1);
		glBegin(GL_QUADS);
		glVertex2i(365, 228 - j);
		glVertex2i(365, 238 - j);
		glVertex2i(370, 238 - j);
		glVertex2i(370, 228 - j);
		glEnd();
		glFlush();
	...
	for (i = 0; i < 235; i = i + temp) //movement of data packet sidewise
	{
		glColor3f(0, 1, 1);
		glBegin(GL_QUADS);
		glVertex2i(355 - i, 178);
		glVertex2i(355 - i, 183);
		glVertex2i(365 - i, 183);
		glVertex2i(365 - i, 178);
		glEnd();
		glFlush();
	...
	for (j = 0; j < 55; j = j + temp) //to move the  packet from bottom to top
	{
		glColor3f(0, 1, 1);
		glBegin(GL_QUADS);
		glVertex2i(115, 178 + j);
		glVertex2i(115, 188 + j);
		glVertex2i(120, 188 + j);
		glVertex2i(120, 178 + j);
		glEnd();
		glFlush();
...
void move8() // MOVEMENT OF ACK 4 (in packet crashing)
{
	...
	for (j = 0; j < 4; j = j + temp) //movement of data packet within the frame
	{
		glColor3f(0, 1, 1);
		glBegin(GL_QUADS);
		glVertex2i(335, 265 - j);
		glVertex2i(335, 275 - j);
		glVertex2i(340, 275 - j);
		glVertex2i(340, 265 - j);
		glEnd();
		glFlush();
	...
	for (j = 0; j < 50; j = j + temp) //movement of data packet from top to down
	{
		glColor3f(0, 1, 1);
		glBegin(GL_QUADS);
		glVertex2i(335, 228 - j);
		glVertex2i(335, 238 - j);
		glVertex2i(340, 238 - j);
		glVertex2i(340, 228 - j);
		glEnd();
		glFlush();
	...
	for (i = 0; i < 235; i = i + temp) //movement of data packet sidewise
	{
		glColor3f(0, 1, 1);
		glBegin(GL_QUADS);
		glVertex2i(325 - i, 178);
		glVertex2i(325 - i, 183);
		glVertex2i(335 - i, 183);
		glVertex2i(335 - i, 178);
		glEnd();
		glFlush();
...
void move10() // SIMULTANEOUS MOVEMENT  OF NAK 2 AS FRAME 2 IS LOST AND  FRAME 4  (in packet crashing)
{
	...
	for (j = 0; j < 4; j = j + temp) //movement of data packet within the frame
	{
		...
		glColor3f(1, 0, 0);
		glBegin(GL_QUADS);
		glVertex2i(115, 265 - j);
		glVertex2i(115, 280 - j);
		glVertex2i(120, 280 - j);
		glVertex2i(120, 265 - j);
		glEnd();
		glFlush();
	...
	for (j = 0; j < 50; j = j + temp) //movement of data packet from top to down
	{
		...
		glColor3f(1, 0, 0);
		glBegin(GL_QUADS);
		glVertex2i(115, 238 - j);
		glVertex2i(115, 253 - j);
		glVertex2i(120, 253 - j);
		glVertex2i(120, 238 - j);
		glEnd();
		glFlush();
	...
	for (i = 0; i < 235; i = i + temp) //movement of data packet sidewise
	{
		...
		glVertex2i(115 + i, 183);
		glVertex2i(115 + i, 188);
		glVertex2i(130 + i, 188);
		glVertex2i(130 + i, 183);
		glEnd();
		glFlush();
	...
	for (j = 0; j < 55; j = j + temp) //to move the  packet from bottom to top
	{
		...
		glColor3f(1, 0, 0);
		glBegin(GL_QUADS);
		glVertex2i(365, 183 + j);
		glVertex2i(365, 198 + j);
		glVertex2i(370, 198 + j);
		glVertex2i(370, 183 + j);
		glEnd();
		glFlush();
...
void move11() // MOVEMENT OF ACK 4 (in packet crashing)
{
	...
	for (j = 0; j < 4; j = j + temp) //movement of data packet within the frame
	{
		glColor3f(0, 1, 1);
		glBegin(GL_QUADS);
		glVertex2i(380, 265 - j);
		glVertex2i(380, 275 - j);
		glVertex2i(385, 275 - j);
		glVertex2i(385, 265 - j);
		glEnd();
		glFlush();
	...
	for (j = 0; j < 50; j = j + temp) //movement of data packet from top to down
	{
		glColor3f(0, 1, 1);
		glBegin(GL_QUADS);
		glVertex2i(380, 228 - j);
		glVertex2i(380, 238 - j);
		glVertex2i(385, 238 - j);
		glVertex2i(385, 228 - j);
		glEnd();
		glFlush();
	...
	for (i = 0; i < 235; i = i + temp) //movement of data packet sidewise
	{
		glColor3f(0, 1, 1);
		glBegin(GL_QUADS);
		glVertex2i(370 - i, 178);
		glVertex2i(370 - i, 183);
		glVertex2i(380 - i, 183);
		glVertex2i(380 - i, 178);
		glEnd();
		glFlush();
	...
	for (j = 0; j < 55; j = j + temp) //to move the  packet from bottom to top
	{
		glColor3f(0, 1, 1);
		glBegin(GL_QUADS);
		glVertex2i(130, 178 + j);
		glVertex2i(130, 188 + j);
		glVertex2i(135, 188 + j);
		glVertex2i(135, 178 + j);
		glEnd();
		glFlush();
...
void move13() // SIMULTANEOUS  MOVEMENT OF ACK 1 AND FRAME 1(in safe sending)
{
	...
	for (j = 0; j < 4; j = j + temp) //movement of data packet within the frame
	{
		glColor3f(0, 1, 1);
		glBegin(GL_QUADS);
		glVertex2i(350, 265 - j);
		glVertex2i(350, 275 - j);
		glVertex2i(355, 275 - j);
		glVertex2i(355, 265 - j);
		glEnd();
		glFlush();
	...
	for (j = 0; j < 60; j = j + temp) //movement of data packet from top to down
	{
		glColor3f(0, 1, 1);
		glBegin(GL_QUADS);
		glVertex2i(350, 228 - j);
		glVertex2i(350, 238 - j);
		glVertex2i(355, 238 - j);
		glVertex2i(355, 228 - j);
		glEnd();
		glFlush();
	...
	for (i = 0; i < 235; i = i + temp) //movement of data packet sidewise
	{
		glColor3f(0, 1, 1);
		glBegin(GL_QUADS);
		glVertex2i(340 - i, 168);
		glVertex2i(340 - i, 173);
		glVertex2i(350 - i, 173);
		glVertex2i(350 - i, 168);
		glEnd();
		glFlush();
	...
	for (j = 0; j < 63; j = j + temp) //to move the  packet from bottom to top
	{
		glColor3f(0, 1, 1);
		glBegin(GL_QUADS);
		glVertex2i(100, 168 + j);
		glVertex2i(100, 178 + j);
		glVertex2i(105, 178 + j);
		glVertex2i(105, 168 + j);
		glEnd();
		glFlush();
